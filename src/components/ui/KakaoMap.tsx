    ...
    <>
      <div className="relative w-full h-64 rounded-lg overflow-hidden">
        ...
        {loaded && (
          ...
          >
            {/* 확대 버튼 힌트 */}
            <div className="absolute top-3 right-3 flex items-center gap-1.5 bg-white/90 backdrop-blur-sm rounded-full pl-2.5 pr-3 h-8 border border-border/60 shadow-sm pointer-events-none">
              <svg
                viewBox="0 0 16 16"
