      ...
      >
        ...
        <div className="overflow-y-auto px-5 py-4">
          <Section title="상단 토글 버튼">
            <Item
              label="예식 후"
              desc="예식 후 모드를 미리보기합니다. ON 시 일시·지도·참석여부·계좌 섹션이 숨겨지고, 감사 갤러리가 표시됩니다. 실제로는 예식 당일(7/11) 자정 이후 자동 전환됩니다."
            />
            <Item
              label="하객갤러리"
              desc="하객 사진 갤러리의 오픈 여부를 미리보기합니다. 실제로는 예식 당일(7/11) 자정부터 자동 오픈됩니다."
            />
            <Item
              label="BGM"
              desc="배경음악의 재생/정지를 전환합니다. 방문자에게는 첫 방문 시 음악 재생 여부를 물어봅니다."
            />
          </Section>
